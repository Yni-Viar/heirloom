...
#define GETRETVAL(type, drive) (aDriveInfo[drive].s##type.dwRetVal)
...
#define R_REFRESH(type, drive) aDriveInfo[drive].s##type.bRefresh = TRUE

#define I_INVALIDATE(type, drive) aDriveInfo[drive].s##type.bValid = FALSE
